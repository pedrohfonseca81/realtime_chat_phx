defmodule RealtimeChatPhx.ChatsTest do
  use RealtimeChatPhx.DataCase
  ...
  describe "messages" do
    ...
    @valid_attrs %{message: "some message", nickname: "some nickname"}
    @update_attrs %{message: "some updated message", nickname: "some updated nickname"}
    @invalid_attrs %{message: nil, nickname: nil}
    ...
    test "create_message/1 with valid data creates a message" do
      ...
      assert message.nickname == "some nickname"
    end
    ...
    test "update_message/2 with valid data updates the message" do
      ...
      assert message.nickname == "some updated nickname"
    end
